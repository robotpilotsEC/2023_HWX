...
//	}
	...
	/*枪管热量限制*/
	if(judge.base_info->shooter_id2_cooling_heat >= 240- 80 )
	{
		if(L_shoot_speed <= -2200)
		{
			L_shoot_speed = -2200;
		}
	}
	else if(judge.base_info->shooter_id2_cooling_heat >= 240- 20 )
	{
		L_shoot_speed = 0;
	...
	if(judge.base_info->shooter_id1_cooling_heat >= 240- 80 )
	{
		if(R_shoot_speed <= -2200)
		{
			R_shoot_speed = -2200;
		}
	}
	else if(judge.base_info->shooter_id1_cooling_heat >= 240- 20 )
	{
		R_shoot_speed = 0;
	...
	if(L_shoot_structure.status == Running_Shoot)
	{
		if(L_shoot_structure.flag.locked == 0)
		{
			...
			{
				L_shoot_structure.base.shoot_speed = -4850;
			}
			/*连发测试*/
	...
	if(R_shoot_structure.status == Running_Shoot)
	{
		if(R_shoot_structure.flag.locked == 0)
		{
			...
			{
				R_shoot_structure.base.shoot_speed = -4850;
			}
