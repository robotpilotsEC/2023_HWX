...
void MOTOR_9015_SPEED()
{
    ...
    motor_9015_structure.tx_buff[4]    = (uint8_t)  motor_9015_structure.base_info->target_speed;
    motor_9015_structure.tx_buff[5]    = (uint8_t) (motor_9015_structure.base_info->target_speed >> 8);
	motor_9015_structure.tx_buff[6]    = (uint8_t) (motor_9015_structure.base_info->target_speed >> 16);
    motor_9015_structure.tx_buff[7]    = (uint8_t) (motor_9015_structure.base_info->target_speed >> 24);
...
//	err = motor_9015_structure.base_info->target_angle - motor_9015_structure.base_info->angle;
//	MOTOR_9015_DATA(CIRCLE_ANGLE_ID);
//	
//	if(err > 0)
//	{
//		spinDirection = 0;
...
//	}
//	
//	if(motor_9015_structure.base_info->target_angle == 0)
//	{
//	   motor_9015_structure.base_info->target_angle = 1;
//	}

	
	/*角度等于0的时候会有问题*/
	motor_9015_structure.tx_buff[0]    = POSI_CLOSE_LOOP_ID3;//单圈角度，有方向
	motor_9015_structure.tx_buff[1]    = 1;
	motor_9015_structure.tx_buff[2]    = 0x00;
    motor_9015_structure.tx_buff[3]    = 0x00;
    motor_9015_structure.tx_buff[4]    = (uint8_t)  motor_9015_structure.base_info->target_angle;
    motor_9015_structure.tx_buff[5]    = (uint8_t) (motor_9015_structure.base_info->target_angle >> 8);
...
void MOTOR_9015_STOP()
{
	...
	motor_9015_structure.tx_buff[0]    = MOTOR_CLOSE_ID;//单圈角度，有方向
	motor_9015_structure.tx_buff[1]    = 0x00;
	motor_9015_structure.tx_buff[2]    = 0x00;
    motor_9015_structure.tx_buff[3]    = 0x00;
